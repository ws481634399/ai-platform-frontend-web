...
describe('dynamic routes', () => {
  ...
  it('STORY-001-03-02-02/TC-002 rejects external paths and unknown components', () => {
  ...
  it('STORY-001-03-02-02/TC-003 registers idempotently and clears only dynamic routes', () => {
    const instance = router()
